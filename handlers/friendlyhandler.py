...
""" Handles generating the friendly page for the application.
...
class FriendlyHandler(webapp.RequestHandler):
  def get(self):
    cachename = 'friendlyview' + os.environ['CURRENT_VERSION_ID']
    ...
    if view is None:
      ...
      tvars = {
        ...
        ,'activeTab': 'friendly'
        ,'title': app.locale.l['title_friendly']
